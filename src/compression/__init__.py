...
from .dcvc_int16_encoder import compress_keep_streams_dcvc_int16
...
def compress_keep_streams(
    *,
    ...
    if codec in {"dcvc_int16", "int16", "dcvc_rt_int16", "dcvc_rt", "dcvc-rt"}:
        return compress_keep_streams_dcvc_int16(
...
__all__ = [
    ...
    "compress_keep_streams_dcvc_int16",
    "encode_roi_bg_ffmpeg",
]
