...
# ── Compatibility wrapper for phase_decompress.py ────────────────────────────
...
def decode_stream_bytes(
    ...
    """
    API bridge for phase_decompress.py.

    Delegates directly to _decode_stream_bytes_dcvc with the same arguments.
    """
