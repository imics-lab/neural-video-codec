...
def _ensure_matching_cuda_home() -> None:
    # Match CUDA runtime version expected by torch wheels (e.g., cu121).
...
def _ensure_windows_dll_dirs() -> None:
    # Ensure Windows loader can resolve torch/CUDA DLL dependencies of .pyd.
