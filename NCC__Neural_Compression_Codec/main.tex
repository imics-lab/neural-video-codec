...
Table~\ref{tab:rd} compares methods at their respective quality settings. The dual-stream scheme concentrates bits in the ROI while aggressively compressing the background, achieving smaller archive sizes than H.264 at comparable perceptual quality. The RestoreUNet stage further improves PSNR, SSIM, and VMAF over the unrestored dual-stream output by suppressing background blocking artifacts.

\begin{table}[t]
\centering
\caption{Rate-distortion comparison. Archive size is for the test clip (1280$\times$720). VMAF is Netflix's perceptual quality score (higher = better).}
\label{tab:rd}
\begin{tabular}{lrcccc}
\toprule
Method & KB & PSNR & SSIM & LPIPS & VMAF \\
\midrule
H.264 CRF 18        & \TODO{} & \TODO{} & \TODO{} & \TODO{} & \TODO{} \\
H.264 CRF 28        & \TODO{} & \TODO{} & \TODO{} & \TODO{} & \TODO{} \\
H.264 CRF 40        & \TODO{} & \TODO{} & \TODO{} & \TODO{} & \TODO{} \\
DCVC uniform QP 25  & \TODO{} & \TODO{} & \TODO{} & \TODO{} & \TODO{} \\
DCVC uniform QP 40  & \TODO{} & \TODO{} & \TODO{} & \TODO{} & \TODO{} \\
DCVC dual, no rest. & \TODO{} & \TODO{} & \TODO{} & \TODO{} & \TODO{} \\
Ours (full)         & \TODO{} & \TODO{\textbf{}} & \TODO{\textbf{}} & \TODO{\textbf{}} & \TODO{\textbf{}} \\
\bottomrule
\end{tabular}
\end{table}
...
At $d{=}3$ DDIM steps and $t_s{=}50$, RestoreUNet processes 1280$\times$720 frames at approximately 119\,ms/frame on a single NVIDIA A5000 (24\,GB) with tiling enabled (tile size 256, overlap 32, tile batch 4). Because tiling chunk overhead dominates over per-step compute, throughput is nearly independent of step count across the range $d \in \{1,\ldots,20\}$.
