...
\title{Guided Diffusion for Targeted Synthetic Data Generation via Conditional Imputation}
...
\author{%
  Mykhailo~Sakevych\thanks{github.com/} \\
  ...
  \And
  Vangelis~Metsis\thanks{https://smiksha1701.github.io/} \\
  Department of Computer Science\\
  Texas State University\\
  San Marcos, TX 78666 \\
  \texttt{ukb12@txstate.edu} \\
